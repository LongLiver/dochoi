...
<body> 
    ...
    <div class="wrapper">
        <div class="header">
            <!-- Chưa th^^ấy hi^^ển thi ten dang nhap -->
        ...
        <div class="menu">
            ...
            <ul style="font-family:'Comic Sans MS';font-size:30px;color:black;text-align:center;">
                ...
                <li><a href="http://localhost/php/Introduce.php"target="_blank"> Giới thiệu </a></li>
    ...
    <option>Gấu</option>
        ...
        <div class="right">
            <h1>2022</h1>
            <p style="font-family:'Comic Sans MS';font-size:30px;"><b>Những mẫu gấu bông bán chạy nhất tháng 6/2022</b></p>
...
//Kết nối theo Mysqli procedural
                ...
                <img src="images/<?php echo $row['Product_Image'] ?>" width="150px" height="150px" />
                <p style="color:red;"><b>Giá thành: <?php echo $row['Product_Price'] ?></b></p>                
                <a href="http://localhost/php/Chi%20ti%e1%ba%bft%20sp.php?id=<?php echo $row['Product_ID'] ?>">Chi tiết</a>   
                  </div>             
                <?php
                }
                ?>
        ...
        <img style="height:400px;width:1200px;" src="https://cf.shopee.vn/file/1212067d874da09697d6405ddf999f77" />
       
        
        <div class="footer">
            
            <div class="footercontent">
                <p style="font-family: 'Comic Sans MS'; font-size: 30px;"><b>Đăng ký ngay bằng tài khoản Gmail để nhận được ưu đãi đặc biệt </b></p>
                <input type="text" name="" placeholder="Gmail của bạn *" style="background-color:greenyellow; border-color: darkred;border-top: none;border-left: none;border-right: none;width: 300px;">
                ...
                <input type="submit" name="Gửi" style="background-color:black;color: rgb(255, 228, 225);border: none; width: 150px;height: 60px;">
            </div>
             </div>
        </div>
    </div>
...
$result = mysqli_query($connect,$sql);
if($result){
    echo"add account success";
}
else{
    echo"add account fail";
}
?>
</body>
</html>
